...
### [Access the list of questions here.](Questions/PythonWeeklyAssignment_Merged.pdf)


### Assignment - 1 (Playing With Numbers)
- [To print the last digit.](Assignment1/Prog1.py)
- [Print the second last digit](Assignment1/Prog2.py)
- [Exchange the last two digits](Assignment1/Prog3.py)
- [Find product after exchaning last digits](Assignment1/Prog4.py)
- [Print the sum of last two digits](Assignment1/Prog5.py)
